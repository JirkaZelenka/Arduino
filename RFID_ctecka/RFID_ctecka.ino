...
void loop() {
  ...
  if(rfid.uid.uidByte[0] == 0x80 & rfid.uid.uidByte[1] == 0x40 & rfid.uid.uidByte[2] == 0xEB & rfid.uid.uidByte[3] == 0x89) {
    Serial.println("Detekovana bila karta!");
  }
  else if(rfid.uid.uidByte[0] == 0x76 & rfid.uid.uidByte[1] == 0x2C & rfid.uid.uidByte[2] == 0xE3 & rfid.uid.uidByte[3] == 0x73) {
