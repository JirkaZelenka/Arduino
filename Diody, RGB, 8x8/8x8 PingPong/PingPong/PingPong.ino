...
// Tady jsem se trochu zapotil, chyba bya v pojemenování knihovny TImer a já tam dal Timer.H, pak jsem ještě zjistil,
// že je tu špatně udělaný komentář kteý kazí kod ale opravil sjem ho nejdřív jen částečně..musím říct že chybové hlášky nejsou moc nápomocné...
